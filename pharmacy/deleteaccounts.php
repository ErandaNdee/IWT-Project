...
<br/><br/><br/><br/><br/><br/><br/><br/>		
  ...
  font-size: 20px;
	...
	{	
		...
		echo "</table>";
			echo "<table border='1'  id='product'> <tr> <th>Register number</th>
			...
			while($row = $result ->fetch_assoc())
			{
		        ...
		        $id =$row["regNo"]; 
				Echo "<tr> <td>" .$row['regNo']."</td> <td> " .$row['email']."</td><td>" .$row['password']."</td><td>" .$row['lname']."</td><td>" .$row['fname']."</td><td>" .$row['address']."</td><td>" .$row['phone']."</td><td><button id = 'delete'><a href ='submitmanage.php?id=$id'>delete</a></button></td></tr>";
				echo "<br/>";
		}
		echo "</table>";
	}		
